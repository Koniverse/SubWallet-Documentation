...
_(\*): The swapping process on Uniswap Labs Trading API & KyberSwap differs slightly from other providers. Refer to this_ [_guide_](single-chain-swap.md) _for the complete procedure._
...
{% content-ref url="single-chain-swap.md" %}
[single-chain-swap.md](single-chain-swap.md)
{% endcontent-ref %}
