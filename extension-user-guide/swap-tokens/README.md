...
_(\*): The swapping process on Uniswap Labs Trading API & KyberSwap differs slightly from other providers. Refer to this_ [_guide_](<single-chain-swap (1).md>) _for the complete procedure._
...
{% content-ref url="single-chain-swap (1).md" %}
[single-chain-swap (1).md](<single-chain-swap (1).md>)
{% endcontent-ref %}
