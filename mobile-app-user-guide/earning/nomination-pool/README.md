...
{% content-ref url="../../../extension-user-guide/manage-staking/nomination-pool/start-staking.md" %}
[start-staking.md](../../../extension-user-guide/manage-staking/nomination-pool/start-staking.md)
{% endcontent-ref %}
