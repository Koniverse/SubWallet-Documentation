...
{% hint style="warning" %}
During the migration process, **DO NOT** close the Web dashboard. If you close it, the migration will be temporarily stopped.

To continue the migration, open the Web dashboard, click "**Continue**", re-enter your password, and then select "**Continue**" to resume the process.
...
<summary>If you close SubWallet Web dashboard during the migration process</summary>

If you close it, the migration will be temporarily stopped. In order to continue using the wallet on this platform, you must complete the migration.
