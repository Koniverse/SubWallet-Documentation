...
Follow [this instruction](../../extension-user-guide/network-management/customize-your-networks/enable-disable-networks.md) to enable the networks you want to use.
{% endhint %}
