...
_In this example, we will connect Ledger accounts to SubWallet by choosing the Polkadot Migration app on the Ledger Nano X device._

<div><figure><img src="../../../.gitbook/assets/photo_2024-12-04_03-58-35.jpg" alt="" width="563"><figcaption></figcaption></figure> <figure><img src="../../../.gitbook/assets/photo_2024-12-04_03-58-38 (1).jpg" alt="" width="563"><figcaption></figcaption></figure></div>
...
Click on the device name (Nano X) and click "**Connect**".

**Step 6**: Select the network you want to use with the Polkadot Migration app.&#x20;
...
After your Ledger has been successfully found by SubWallet, click "**Connect Ledger device**".
