...
_(\*): Ledger Nano S is being phased out by Ledger (read this_ [_article_](https://support.ledger.com/article/Ledger-Nano-S-Limitations)_). If you have this device, upgrade it to the newer Ledger devices for a more seamless experience, with the latest and future features and security improvements._
...
_For example, to connect Ledger Avail account(s) to SubWallet, you need to choose the Avail app on your Ledger and then select the "**Avail**" option on SubWallet._
...
_For example, to connect Ledger Arbitrum One account(s) to SubWallet, you need to choose the Arbitrum One app on your Ledger and then select the "**EVM networks**" option on SubWallet._
