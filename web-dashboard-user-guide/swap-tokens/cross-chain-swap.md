...
{% hint style="info" %}
Ensure the token you want to swap and the token you wish to receive are on the same network; otherwise, check out this [guide](single-chain-swap.md).
{% endhint %}
...
![](<../../.gitbook/assets/image (2176).png>) ![](<../../.gitbook/assets/image (2177).png>)
{% endhint %}
