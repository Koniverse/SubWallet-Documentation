...
_(\*): The swapping process on Uniswap Labs Trading API & KyberSwap differs slightly from other providers. Refer to this_ [_guide_](<../../extension-user-guide/swap-tokens/single-chain-swap (1).md>) _for the complete procedure._
...
{% content-ref url="../../extension-user-guide/swap-tokens/single-chain-swap (1).md" %}
[single-chain-swap (1).md](<../../extension-user-guide/swap-tokens/single-chain-swap (1).md>)
{% endcontent-ref %}

{% content-ref url="../../extension-user-guide/swap-tokens/cross-chain-swap.md" %}
[cross-chain-swap.md](../../extension-user-guide/swap-tokens/cross-chain-swap.md)
{% endcontent-ref %}
